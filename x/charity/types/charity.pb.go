...
func (m *Charity) GetDateCreated() string {
	if m != nil {
...
type Params struct {
	...
	CharityTwo *Charity `protobuf:"bytes,2,opt,name=charity_two,json=charityTwo,proto3" json:"charity_two,omitempty"`
}
...
var fileDescriptor_5b141662e81c4bb5 = []byte{
	...
	,
}
...
func (m *Charity) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DateCreated) > 0 {
		...
		i = encodeVarintCharity(dAtA, i, uint64(len(m.DateCreated)))
		i--
		dAtA[i] = 0x12
	}
